...
function [Q, R,perm] = qr_Householder_pivoting_custom(A, fixed_pivots)
[m,n] = size(A);
perm = 1 : n; 
...
% Now first we re-arrange the columns of A to have the pivots!
vec_star = [fixed_pv
A = A * permutation(vec_star);
