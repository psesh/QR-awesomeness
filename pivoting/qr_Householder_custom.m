...
% that fixes certain pivot columns. So if fixed_pivots has n
% entries, they must be equal to the first n entries of perm.
%
% Copyright (c) 2016 by Pranay Seshadri
function [Q, R,perm] = qr_Householder_pivoting(A, fixed_pivots)
[m,n] = size(A);
perm = 1 : n;
